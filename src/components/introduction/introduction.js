    ...
    render() {
        return (
            <div id = "introduction">
                ...
                <a class = "ref-link" rel = "noopener noreferrer" target = "_blank" href = "mailto:mail@rohanupponi.com"><div id = "mail-button" class="ref-cont"><i class="ref fa fa-envelope-o"/></div></a>
